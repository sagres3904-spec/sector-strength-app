...
def bundle_to_markdown(bundle: dict[str, Any]) -> str:
    lines = [
        ...
        f"- generated_at_utc: {bundle['meta'].get('generated_at_utc', '')}",
        f"- generated_at_jst: {bundle['meta'].get('generated_at_jst', '')}",
        f"- mode: {bundle['meta']['mode']}",
        f"- is_true_timepoint: {bundle['meta'].get('is_true_timepoint', '')}",
        f"- expected_time_label: {bundle['meta'].get('expected_time_label', '')}",
